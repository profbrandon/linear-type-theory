...
helpMenu =
  "\n\
   \Help Menu Syntax\n\n\
    ...
    \\tname                            A variable or keyword 'name'\n\
    \\t<name>                          A meta-variable\n\
   ...
   \Terms\n\n\
    ...
    \\tlowercase {alnum | _ | '}       Term variables\n\n\
    ...
    \\tinl <type> <term>               Sum type left injection.\n\
    \\tinr <type> <term>               Sum type right injection.\n\n\
    ...
    \\trec+ ( <Type> , <term>          Sum recursion. The type given should be\n\
    \\t              , <term>          the conclusion of the first and second\n\
    \\t              , <term> )        terms. Note that the context is shared\n\
    \\t                                between these two function terms. The last\n\
    \\t                                term is a sum term.\n\n\
   ...
   \Types\n\n\
    ...
    \\tuppercase {alnum | _ | '}       Type variables\n\n\
    ...
    \\t<Type> + <Type>                 Sum types (Disjunction), created via the\n\
